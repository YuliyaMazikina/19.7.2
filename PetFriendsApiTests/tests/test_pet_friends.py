...
# Мой тест 3
def test_add_pet_new_photo(pet_photo='images/Kot_No.xlsx'):
...
# Мой тест 4
def test_get_api_key_for_invalid_user_email(email='no403', password=valid_password):
...
# Мой тест 5
def test_get_api_key_for_invalid_user_password(email=valid_email, password='654321'):
...
# Мой тест 6
def test_add_new_pet_with_negative_age(name='Кузя', animal_type='Британец',
                                       age='-1', pet_photo='images/kot.jpg'):
...
# Мой тест 7
def test_add_new_pet_with_too_old_age(name='Ореш', animal_type='Сиамский',
                                       age='1000000', pet_photo='images/kot111.jpg'):
...
# Мой тест 8
def test_add_new_pet_with_invalid_age(name='Кузя', animal_type='Британец',
                                       age='', pet_photo='images/kot.jpg'):
...
def test_add_new_pet_with_long_name(name='ввввввввввввввввввввввввввввввввввввввввввввввввввв',
    ...
    # Сверяем полученный ответ с ожидаемым результатом
    assert status == 200
    print('Баг - сайт позволяет добавить питомца с именем длиннее 51 символ')
